...
function index() {
  return (
    <Wrapper>
      ...
      <Intro>
        <p>
          (사)경기북부지역발전연구원은 경기북부지역의 성장발전을 이끄는 원동력의 역할 수행을 목표로
          2021년 3월 설립되었습니다. 경기북부지역의 경제활성화를 위한 기본계획과 정책을 수립하고,
          지역산업의 경쟁력 제고를 위한 제분야의 연구조사활동을 종합적으로 수행하여 지역경제발전
          전략 및 정책이 체계적이고 효율적으로 실행될 수 있도록 구체적 실행방안 제공을 주요
          활동업무로 하고 있습니다.
        </p>
        <p>
        ...
        <p>
          ...
          외에 여러분의 보다 많은 관심과 조언이 절실히 필요합니다. 여러분과 함께할 때 비로소 가능한
          일입니다. 부탁의 말씀과 더불어 저희 연구소가 추진하고 있는 각종 학술행사와 연구프로젝트의
          전모를 여러분 모두와 공유하는 공간으로서의 홈페이지가 될 수 있도록 최선을 다할 것을
          약속드립니다. 저희 연구원을 방문해 주셔서 감사합니다.
        </p>
      </Intro>
      <Vision>
        <div>
